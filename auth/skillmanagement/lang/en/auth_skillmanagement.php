...
$string['auth_skillmanagementdescription'] = '<p>Skills-management self-registration enables a user to create their own account via a \'Create new account\' button on the login page. The user then receives an email containing a secure link to a page where they can confirm their account. Future logins just check the username and password against the stored values in the Moodle database. Additionally a course is created where the user is enrolled as teacher, and a additional account "Participant" is created.</p>
...
$string['auth_skillmanagementrecaptcha'] = 'Adds a visual/audio confirmation form element to the signup page for Skillsmanagement self-registering users. This protects your site against spammers and contributes to a worthwhile cause. See http://www.google.com/recaptcha/learnmore for more details. <br /><em>PHP cURL extension is required.</em>';
$string['auth_skillmanagementrecaptcha_key'] = 'Enable reCAPTCHA element';
$string['auth_skillmanagementsettings'] = 'Settings';
$string['course_description'] = '<p><h2>Define, deploy and develop skills with your employees!</h2></p><br/><p>1. The first step is to define the skills/outcomes needed in your organization. We have imported some demo-data for you to see how the module works.<br/>Click on the link <b>"Competence grid" on the right hand side</b> and turn editing on to add your own.</p><br/><img src="http://www.skills-management.org/arrow.png"><br/><br/><br/><p>2. Follow the instructions on the configuration tabs to work with skills/outcomes.</p><p>3. Login with the second user (employee_[yourloginname]) that was created to see how the competence profile develops. You can also access the competence profile of the employee-user by selection "Employee of company" from the competence-grid-tab.</p>';
